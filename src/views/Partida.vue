         ...
         <!-- <div class="row g-3">            -->
            <!-- <div class="col-sm-9"> -->
              ...
              <!-- Contenido de la pantalla -->
                ...
                <h2>{{ $t('partidasCurso.partidaContra1') }} {{adversario}} - {{mensaje}}</h2>


                <div class="row">
                  <div class="column"> <h3>{{ $t('partida.tuFlota') }}</h3> </div>
                  <div class="column"> <h3>{{ $t('partida.flotaDe') }} {{adversario}}</h3> </div>
                </div>
  ...
  computed:{
    ...
    mensaje :function(){
      ...
      if (this.turnoActual === 'TurnoRival'){
        retVal = this.$t('partida.turnoRival')
      }
      if (this.turnoActual === 'ColocandoBarcos'){
        retVal = this.$t('partida.colocaBarcos')
      }
