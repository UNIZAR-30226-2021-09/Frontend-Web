         ...
         <div class="row g-3">
            <div class="container col-sm-9 " >
                ...
                <div class="container border rounded border-5 bg-white " >
                    ...
                    <button v-if="seleccionados" type="button" class="btn btn-outline-secondary" @click="crearTorneo()">
                    ...
                    <button v-if="!seleccionados" type="button" class="btn btn-outline-secondary disabled" @click="crearTorneo()">
                      <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" class="bi bi-plus" viewBox="0 0 16 16">
                        <path d="M8 4a.5.5 0 0 1 .5.5v3h3a.5.5 0 0 1 0 1h-3v3a.5.5 0 0 1-1 0v-3h-3a.5.5 0 0 1 0-1h3v-3A.5.5 0 0 1 8 4z"/>
                      </svg>
                      {{ $t('boton.crearTorneo') }}
...
export default {
  ...
  computed: {
    ...
    seleccionados: function(){
      return this.participantes[1].nombre != '' && this.participantes[2].nombre != '' && this.participantes[3].nombre != ''
    }
  },
